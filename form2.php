...
// Fetch request form data and join with notification table
$sql = "SELECT rf.RequestID, rf.PICName, rf.RequestDate, rf.ApprovedDate, rf.RequestStatus, 
               n.StockEntryDate 
        FROM requestform rf 
        LEFT JOIN notification n ON rf.RequestID = n.RequestID 
...
<div class="main">
        ...
        <div class="container" style="background-color:#f1f1f1; text-align: center; padding: 20px;">
                      ...
                      <div class="log-card">
                          <div class="log-content">
                              <p class="request-date">
                                  <strong>
                                      <a href="viewform1.php?id=<?php echo $row['RequestID']; ?>" style="text-decoration: none; color: black;">
                              ...
                              <div class="log-detail request-status" style="display: none;">
                          ...
                          <div class="log-status">
                              ...
                              <!-- Show edit button only if status is Approved AND StockEntryDate is empty -->
                              <?php if ($row['RequestStatus'] === 'Approved' && (empty($row['StockEntryDate']) || $row['StockEntryDate'] == '00:00:00')): ?>
                                  <a href="notificationform.php?id=<?php echo $row['RequestID']; ?>" class="edit-icon">
                                      <img src="img/open-mail.png" alt="Edit" />
                                  </a>
                              <?php endif; ?>
                          </div>
                      </div>
          ...
          <!-- Always in DOM but hidden if records exist -->
          ...
          <div style="display: flex; justify-content: center; align-items: center;">
            <a href="OfficeHomePage.php" class="back">
    ...
    <script>
      ...
      requestCards.forEach(card => {
          ...
          let requestStatus = card.querySelector(".request-status").innerText.toLowerCase(); // Include status

          if (requestName.includes(input) || requestDate.includes(input) || requestStatus.includes(input)) {
              card.style.display = "flex"; // Ensure the original layout is kept
              found = true;
          } else {
      ...
      // Show "No requests found" message if nothing matches
