...
if (isset($_GET['id'])) {
    ...
    $sql = "SELECT r.PICName, r.ItemID, r.Amount, r.RequestDate, r.ApprovedDate, i.ItemName, r.StoreID
            FROM requestform r
...
<div class="main">
        ...
        <div class="container" style="background-color:#f1f1f1">
            <h3 style="margin-bottom: 40px;">Approved Form </h3>
            
            <form action="notificationaccess.php" method="POST" enctype="multipart/form-data" style="max-width: 1000px; margin: auto; padding: 20px; border-radius: 10px; background: #f9f9f9;">
            <input type="hidden" name="requestID" value="<?php echo $requestID; ?>">

            <label for="picName">Person In Charge Name</label>
            <input type="text" name="picName" id="picName" value="<?php echo $picName; ?>" readonly
            ...
            <table class="list-of-items">
                ...
                <tr>
                    <td style="padding: 10px; text-align: center;"><?php echo $storeID; ?></td>   
                    <td style="padding: 10px; text-align: center;"><?php echo $itemName; ?></td>
                    <td style="padding: 10px; text-align: center;"><?php echo $amount; ?></td>
                </tr>
            </table>

            <!-- Hidden input fields to ensure data is sent in the form -->
            <input type="hidden" name="amount" value="<?php echo $storeID; ?>">
            <input type="hidden" name="itemName" value="<?php echo $itemName; ?>">
            <input type="hidden" name="amount" value="<?php echo $amount; ?>">

            <label for="requestDate">Date of Request:</label>
            <input type="text" name="requestDate" id="requestDate" value="<?php echo $requestDate; ?>" readonly
            required style="width: 100%; padding: 10px; margin-bottom: 10px; border-radius: 5px; border: 1px solid #ccc;">

            <label for="approvedDate">Date of Approval:</label>
            <input type="text" name="approvedDate" id="approvedDate" value="<?php echo $approvedDate; ?>" readonly
            required style="width: 100%; padding: 10px; margin-bottom: 10px; border-radius: 5px; border: 1px solid #ccc;">

            <label for="stockEntryDate">Date of Stock Entry:</label>
            <input type="date" name="stockEntryDate" id="stockEntryDate" required
            required style="width: 100%; padding: 10px; margin-bottom: 10px; border-radius: 5px; border: 1px solid #ccc;">
