...
<div class="main">
        ...
        <div class="container" style="background-color:#f1f1f1; text-align: center; padding: 20px;">
            <h3 style="margin-bottom: 40px;">Store 1 - Cables, Wires and Cable Management </h3>
            ...
            <form>
                ...
                <button onclick="searchItems()">Search</buttonlog>
                  ...
                  <div class="right-section" style="margin-left: 20px;">
                      <a href="add_item1.php?storeID=1" class="add-button" style="margin-bottom: 20px;">Add Item</a>
                  </div>
          </div>
          
        <div class="inventory-grid">
        <?php
            $sql = "SELECT * FROM item WHERE StoreID = 1"; // Fetch only Store 1 items
            ...
            if ($result->num_rows > 0) {
              while ($row = $result->fetch_assoc()) {
                  ...
                  echo '<a href="checkouthistory1.php?id=' . $row["ItemID"] . '&store=' . $row["StoreID"] . '">';
                  ...
                  echo '<a href="updateitem1.php?id=' . $row["ItemID"] . '" class="update-button">Update</a>';
                  echo '</div>';
                  }
              } else {
                  echo "No items found.";
          ...
          <div style="display: flex; justify-content: center; align-items: center;">
            <a href="inventory2.php" class="back">
