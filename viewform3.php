<?php
session_start();
include 'conn.php'; // Ensure this contains the correct DB connection
...
// Fetch Notification Details and related Item Details (including StoreID)
$query = "
    SELECT n.PICName, n.ItemID, n.Amount, n.RequestDate, n.ApprovedDate, n.StockEntryDate, 
           i.StoreID, i.ItemName 
    FROM notification n
    JOIN item i ON n.ItemID = i.ItemID
...
$PICName = htmlspecialchars($row['PICName']);
...
$ApprovedDate = htmlspecialchars($row['ApprovedDate']);
$StockEntryDate = htmlspecialchars($row['StockEntryDate']);
...
<div class="main">
        ...
        <form enctype="multipart/form-data" style="max-width: 1000px; margin: auto; padding: 20px; border-radius: 10px; background: #f9f9f9;">
            ...
            <input type="text" value="<?php echo $PICName; ?>" readonly required 
            ...
            <input type="text" value="<?php echo $RequestDate; ?>" readonly required 
                style="width: 100%; padding: 10px; margin-bottom: 10px; border-radius: 5px; border: 1px solid #ccc;">
            ...
            <input type="text" value="<?php echo $StockEntryDate; ?>" readonly required 
                style="width: 100%; padding: 10px; margin-bottom: 0px; border-radius: 5px; border: 1px solid #ccc;">
        </form> </div>
        
          <div style="display: flex; justify-content: center; align-items: center;">
            <a href="mailbox.php" class="back">
