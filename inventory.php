            ...
            <div class="column-66">
                ...
                <h4>List of Store</h4><br>
                    <div class="store-list">
                        <a href="store1.php" class="store-card" style="text-decoration: none; color: inherit;">
                            <h3>Store 1</h3>
                            <p>Location: Jalan Andenium 5</p>
                            <strong>Cables, Wires, Cable Management</strong>
                        </a>

                        <a href="store2.php" class="store-card" style="text-decoration: none; color: inherit;">
                            <h3>Store 2</h3>
                            <p>Location: Jalan Andenium 13</p>
                            <strong>Switch, Sockets, Panels</strong>
                        </a>

                        <a href="store3.php" class="store-card" style="text-decoration: none; color: inherit;">
                            <h3>Store 3</h3>
