...
// Retrieve full name of the logged-in user
$queryUser = "SELECT fullname FROM user WHERE username = ?";
...
// Fetch request details where PICName matches logged-in user
$query = "SELECT r.*, u.fullname 
          FROM requestform r 
          JOIN user u ON r.PICName = u.fullname 
          WHERE r.RequestID = ? AND u.fullname = ?";
...
if ($result->num_rows > 0) {
    ...
    $ItemName = htmlspecialchars($row['ItemID']); // Assuming this should be fetched from an item table
    ...
    $StockEntryDate = isset($row['StockEntryDate']) ? htmlspecialchars($row['StockEntryDate']) : 'N/A';
...
<div class="main">
        ...
        <div class="container" style="background-color:#f1f1f1">
          ...
          <div style="display: flex; justify-content: center; align-items: center;">
            <a href="formmenu.php" class="back">
