...
if ($_SERVER["REQUEST_METHOD"] == "GET" && isset($_GET['id']) && isset($_GET['store'])) {
    ...
    header("Location: SiteStore1.php");
    exit();
}
?>
          ...
          <div class="search-add" style="display: flex; justify-content: center; align-items: center;">
            ...
            <form onsubmit="return false;">
                <input type="text" id="searchInput" placeholder="Search items..." onkeyup="searchItems()">
                  ...
                  <a href="SiteCheckout.php?storeID=1" class="add-button" style="margin-bottom: 20px;">Cart</a>
                  </div>
          </div>
                ...
                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                        ...
                        if ($row["Amount"] == 0) {
                            ...
                            echo '<a href="SiteStore1.php?id=' . $row["ItemID"] . '&store=' . $row["StoreID"] . '" class="update-button">Add</a>';
                        }
