...
<div class="main">
    ...
    <br>
        ...
        <div class="container" style="background-color:#f1f1f1">
            ...
            <!-- Move the delete form OUTSIDE the update form -->
            <form action="AccessDeleteUser.php" method="POST" onsubmit="return confirm('Are you sure you want to delete this user?');" style="margin-top: 10px;">
                <input type="hidden" name="id" value="<?php echo $user['id']; ?>">
                <button type="submit" style="flex: 1; padding: 10px; background: red; color: white; border: none; border-radius: 5px; cursor: pointer; height: 40px;">
                    Delete User
                </button>
            </form>
                </div>
