...
if ($_SERVER["REQUEST_METHOD"] == "GET" && isset($_GET['id']) && isset($_GET['store'])) {
    ...
    header("Location: SiteStore2.php");
    exit();
}
?>
            ...
            <form onsubmit="return false;">
                <input type="text" id="searchInput" placeholder="Search items..." onkeyup="searchItems()">
                  ...
                  <div class="right-section" style="margin-left: 20px;">
                      <a href="SiteCheckout.php?storeID=2" class="add-button" style="margin-bottom: 20px;">Cart</a>
                  </div>
          </div>
                ...
                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                        ...
                        if ($row["Amount"] == 0) {
                            ...
                            echo '<a href="SiteStore2.php?id=' . $row["ItemID"] . '&store=' . $row["StoreID"] . '" class="update-button">Add</a>';
                        }
